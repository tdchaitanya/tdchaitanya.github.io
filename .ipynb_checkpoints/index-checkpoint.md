...
<table class='news-table' >
    ...
    <col width="85%">
    <tr>
        <td valign="top"><strong>[Feb 2026]</strong></td>
        <td>After an incredible 3.5 years and a lot of learnings, I have left Fujitsu Research India. It was my first job out of a Master's degree, and probably the most formative stretch of my career so far. I have written a long reflections post <a href="https://log.chaitanya.one/fujitsu-reflections">here</a></td>
    </tr>
    <tr>
    <td valign="top"><strong>[Dec 2025]</strong></td>
        <td>Humbled to be interviewed and featured on the <a href="https://global.fujitsu/en-global/technology/key-technologies/news/ta-ai-agent-interview-20251201">Fujitsu Global Technology Blog</a> discussing our work on Adaptive LLM Routing alongside researchers from Carnegie Mellon University</td>
    </tr>
    <tr>
    <td valign="top"><strong>[Dec 2025]</strong></td>
<td><a href="./resume/4058IN163_2025-12-03_Patent Certificate.pdf">Indian patent granted</a> for our work on object detection in thermal imagery — my first research project as an RA at IIT-Hyderabad, done in collaboration with DRDO, Government of India. 🌟</td>
    </tr>
    <tr>
